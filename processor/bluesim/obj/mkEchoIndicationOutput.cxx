...
/* Constructor */
MOD_mkEchoIndicationOutput::MOD_mkEchoIndicationOutput(tSimStateHdl simHdl,
						       char const *name,
						       Module *parent)
...
void MOD_mkEchoIndicationOutput::init_symbols_0()
{
...
tUInt32 MOD_mkEchoIndicationOutput::METH_portalIfc_messageSize_size(tUInt32 ARG_portalIfc_messageSize_size_methodNumber)
{
...
tUInt8 MOD_mkEchoIndicationOutput::METH_RDY_portalIfc_messageSize_size()
{
...
tUInt32 MOD_mkEchoIndicationOutput::METH_portalIfc_indications_0_first()
{
...
tUInt8 MOD_mkEchoIndicationOutput::METH_RDY_portalIfc_indications_0_first()
{
...
void MOD_mkEchoIndicationOutput::METH_portalIfc_indications_0_deq()
{
  INST_indicationPipes.METH_portalIfc_indications_0_deq();
}

tUInt8 MOD_mkEchoIndicationOutput::METH_RDY_portalIfc_indications_0_deq()
{
...
tUInt8 MOD_mkEchoIndicationOutput::METH_portalIfc_indications_0_notEmpty()
{
...
tUInt8 MOD_mkEchoIndicationOutput::METH_RDY_portalIfc_indications_0_notEmpty()
{
...
tUInt32 MOD_mkEchoIndicationOutput::METH_portalIfc_indications_1_first()
{
...
tUInt8 MOD_mkEchoIndicationOutput::METH_RDY_portalIfc_indications_1_first()
{
...
void MOD_mkEchoIndicationOutput::METH_portalIfc_indications_1_deq()
{
  INST_indicationPipes.METH_portalIfc_indications_1_deq();
}

tUInt8 MOD_mkEchoIndicationOutput::METH_RDY_portalIfc_indications_1_deq()
{
...
tUInt8 MOD_mkEchoIndicationOutput::METH_portalIfc_indications_1_notEmpty()
{
...
tUInt8 MOD_mkEchoIndicationOutput::METH_RDY_portalIfc_indications_1_notEmpty()
{
...
tUInt8 MOD_mkEchoIndicationOutput::METH_portalIfc_intr_status()
{
...
tUInt8 MOD_mkEchoIndicationOutput::METH_RDY_portalIfc_intr_status()
{
...
tUInt32 MOD_mkEchoIndicationOutput::METH_portalIfc_intr_channel()
{
...
tUInt8 MOD_mkEchoIndicationOutput::METH_RDY_portalIfc_intr_channel()
{
...
void MOD_mkEchoIndicationOutput::METH_ifc_heard(tUInt32 ARG_ifc_heard_v)
{
  INST_indicationPipes.METH_methods_heard_enq(ARG_ifc_heard_v);
}

tUInt8 MOD_mkEchoIndicationOutput::METH_RDY_ifc_heard()
{
  tUInt8 DEF_CAN_FIRE_ifc_heard;
  tUInt8 PORT_RDY_ifc_heard;
  DEF_CAN_FIRE_ifc_heard = INST_indicationPipes.METH_RDY_methods_heard_enq();
  PORT_RDY_ifc_heard = DEF_CAN_FIRE_ifc_heard;
  return PORT_RDY_ifc_heard;
}

void MOD_mkEchoIndicationOutput::METH_ifc_heard2(tUInt32 ARG_ifc_heard2_a, tUInt32 ARG_ifc_heard2_b)
{
  tUInt32 DEF_ifc_heard2_a_CONCAT_ifc_heard2_b___d1;
  DEF_ifc_heard2_a_CONCAT_ifc_heard2_b___d1 = (ARG_ifc_heard2_a << 16u) | ARG_ifc_heard2_b;
  INST_indicationPipes.METH_methods_heard2_enq(DEF_ifc_heard2_a_CONCAT_ifc_heard2_b___d1);
}

tUInt8 MOD_mkEchoIndicationOutput::METH_RDY_ifc_heard2()
{
  tUInt8 DEF_CAN_FIRE_ifc_heard2;
  tUInt8 PORT_RDY_ifc_heard2;
  DEF_CAN_FIRE_ifc_heard2 = INST_indicationPipes.METH_RDY_methods_heard2_enq();
  PORT_RDY_ifc_heard2 = DEF_CAN_FIRE_ifc_heard2;
  return PORT_RDY_ifc_heard2;
}


/* Reset routines */

void MOD_mkEchoIndicationOutput::reset_RST_N(tUInt8 ARG_rst_in)
{
...
void MOD_mkEchoIndicationOutput::set_clk_0(char const *s)
{
...
void MOD_mkEchoIndicationOutput::dump_state(unsigned int indent)
{
  printf("%*s%s:\n", indent, "", inst_name);
...
unsigned int MOD_mkEchoIndicationOutput::dump_VCD_defs(unsigned int levels)
{
...
void MOD_mkEchoIndicationOutput::dump_VCD(tVCDDumpType dt,
					  unsigned int levels,
					  MOD_mkEchoIndicationOutput &backing)
{
  vcd_defs(dt, backing);
  if (levels != 1u)
...
void MOD_mkEchoIndicationOutput::vcd_defs(tVCDDumpType dt, MOD_mkEchoIndicationOutput &backing)
{
  unsigned int num = vcd_num;
  if (dt == VCD_DUMP_XS)
  {
...
void MOD_mkEchoIndicationOutput::vcd_submodules(tVCDDumpType dt,
						unsigned int levels,
						MOD_mkEchoIndicationOutput &backing)
{
