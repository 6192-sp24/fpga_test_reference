...
module mkEchoRequestInput(CLK,
  ...
  FIFO1 #(.width(32'd32),
	  .guarded(1'd1)) say2_requestAdapter_fifo(.RST(RST_N),
						   .CLK(CLK),
  ...
  FIFO1 #(.width(32'd32), .guarded(1'd1)) say_requestAdapter_fifo(.RST(RST_N),
								  .CLK(CLK),
  ...
  FIFO1 #(.width(32'd8),
	  .guarded(1'd1)) setLeds_requestAdapter_fifo(.RST(RST_N),
						      .CLK(CLK),
