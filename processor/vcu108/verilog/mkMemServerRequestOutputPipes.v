...
module mkMemServerRequestOutputPipes(CLK,
  ...
  wire [31 : 0] IF_setTileState_responseAdapter_notEmptyReg_TH_ETC___d28;
  wire x__h1117;
  ...
  assign portalIfc_intr_channel =
	     addrTrans_responseAdapter_notEmptyReg ?
	       32'd0 :
	       IF_setTileState_responseAdapter_notEmptyReg_TH_ETC___d28 ;
  ...
  assign addrTrans_responseAdapter_count_D_IN =
	     !addrTrans_responseAdapter_count && x__h1117 ;
  ...
  // remaining internal signals
  assign IF_setTileState_responseAdapter_notEmptyReg_TH_ETC___d28 =
	     setTileState_responseAdapter_notEmptyReg ?
	       32'd1 :
	       (stateDbg_responseAdapter_notEmptyReg ?
		  32'd2 :
		  (memoryTraffic_responseAdapter_notEmptyReg ?
		     32'd3 :
		     32'hFFFFFFFF)) ;
  assign x__h1117 = addrTrans_responseAdapter_count + 1'd1 ;
