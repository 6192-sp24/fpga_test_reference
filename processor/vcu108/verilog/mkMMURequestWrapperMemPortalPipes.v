...
module mkMMURequestWrapperMemPortalPipes(id,
  ...
  reg [31 : 0] v__h3235;
  reg CASE_memslave_ws_first__1_0_dut_RDY_portalIfc__ETC___d77, x__h3367;
  wire [31 : 0] v___1__h3222, v___1__h3312;
  wire [9 : 0] burstCount___1__h1381,
	       burstCount___1__h819,
	       burstCount__h1350,
	       burstCount__h785;
  wire [6 : 0] x__h3915, x__h4168;
  wire [4 : 0] addr__h1348, addr__h783;
  ...
  // register memslave_fifoWriteAddrGenerator_addrReg
  assign memslave_fifoWriteAddrGenerator_addrReg_D_IN = addr__h1348 + 5'd4 ;
  ...
  // submodule memslave_rs
  assign memslave_rs_D_IN = x__h3915[2:0] ;
  ...
  // submodule memslave_ws
  assign memslave_ws_D_IN = x__h4168[2:0] ;
  ...
  assign v___1__h3222 =
		 ...
		 5'd4) ?
		  { 31'd0, x__h3367 } :
		  32'd0) ;
  assign v___1__h3312 = dut_portalIfc_intr_channel + 32'd1 ;
  assign x__h3915 = portalIfc_slave_read_server_readReq_put[27:21] - 7'd1 ;
  assign x__h4168 = portalIfc_slave_write_server_writeReq_put[27:21] - 7'd1 ;
  ...
  begin
    case (memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT[21:17])
      5'd0: v__h3235 = dut_portalIfc_intr_status ? 32'd1 : 32'd0;
      5'd4: v__h3235 = ctrlPort_interruptEnableReg ? 32'd1 : 32'd0;
      5'd8: v__h3235 = 32'd2;
      5'h0C: v__h3235 = dut_portalIfc_intr_status ? v___1__h3312 : 32'd0;
      5'h10: v__h3235 = id;
      5'h14: v__h3235 = ctrlPort_num_portals_reg;
      5'h18: v__h3235 = ctrlPort_cycle_count[63:32];
      5'h1C: v__h3235 = ctrlPort_snapshot;
      default: v__h3235 = 32'h005A05A0;
    endcase
  end
  ...
  begin
    case (memslave_rs_D_OUT)
      3'd0: x__h3367 = dut_portalIfc_requests_0_notFull;
      3'd1: x__h3367 = dut_portalIfc_requests_1_notFull;
      3'd2: x__h3367 = dut_portalIfc_requests_2_notFull;
      3'd3: x__h3367 = dut_portalIfc_requests_3_notFull;
      3'd4: x__h3367 = dut_portalIfc_requests_4_notFull;
      default: x__h3367 = 1'b0 /* unspecified value */ ;
    endcase
  end
