...
module mkMMUIndicationProxySynth(id,
  ...
  reg [31 : 0] v__h2597, v__h2741, x1_avValue_data__h2981;
  reg CASE_memslave_rsD_OUT_0_dutRDY_portalIfc_ind_ETC__q1,
      CASE_memslave_rsD_OUT_0_dutRDY_portalIfc_ind_ETC__q2,
      x__h3024;
  wire [31 : 0] v___1__h2674, x1_avValue_data__h2997;
  wire [9 : 0] burstCount___1__h1316,
	       burstCount___1__h754,
	       burstCount__h1285,
	       burstCount__h720;
  wire [6 : 0] x__h3275, x__h3528;
  wire [4 : 0] addr__h1283, addr__h718;
  ...
  // register memslave_fifoWriteAddrGenerator_addrReg
  assign memslave_fifoWriteAddrGenerator_addrReg_D_IN = addr__h1283 + 5'd4 ;
  ...
  // submodule memslave_rs
  assign memslave_rs_D_IN = x__h3275[1:0] ;
  ...
  // submodule memslave_ws
  assign memslave_ws_D_IN = x__h3528[1:0] ;
  ...
  assign memslave_rvFifo_i_notFull__6_AND_memslave_rsCt_ETC___d85 =
	     ...
	     (memslave_rsCtrl_D_OUT ||
	      NOT_memslave_fifoReadAddrGenerator_addrBeatFif_ETC___d77 &&
	      NOT_memslave_fifoReadAddrGenerator_addrBeatFif_ETC___d82) ;
  assign v___1__h2674 = dut_portalIfc_intr_channel + 32'd1 ;
  assign x1_avValue_data__h2997 =
	     memslave_rsCtrl_D_OUT ? v__h2597 : x1_avValue_data__h2981 ;
  assign x__h3275 = portalIfc_slave_read_server_readReq_put[27:21] - 7'd1 ;
  assign x__h3528 = portalIfc_slave_write_server_writeReq_put[27:21] - 7'd1 ;
  ...
  begin
    case (memslave_rs_D_OUT)
      2'd0: v__h2741 = dut_portalIfc_indications_0_first;
      2'd1: v__h2741 = dut_portalIfc_indications_1_first;
      2'd2: v__h2741 = dut_portalIfc_indications_2_first;
      2'd3: v__h2741 = 32'hAAAAAAAA /* unspecified value */ ;
    endcase
  end
  ...
  begin
    case (memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT[21:17])
      5'd0: v__h2597 = dut_portalIfc_intr_status ? 32'd1 : 32'd0;
      5'd4: v__h2597 = ctrlPort_interruptEnableReg ? 32'd1 : 32'd0;
      5'd8: v__h2597 = 32'd2;
      5'h0C: v__h2597 = dut_portalIfc_intr_status ? v___1__h2674 : 32'd0;
      5'h10: v__h2597 = id;
      5'h14: v__h2597 = ctrlPort_num_portals_reg;
      5'h18: v__h2597 = ctrlPort_cycle_count[63:32];
      5'h1C: v__h2597 = ctrlPort_snapshot;
      default: v__h2597 = 32'h005A05A0;
    endcase
  end
  always@(memslave_rs_D_OUT or
  ...
  begin
    case (memslave_rs_D_OUT)
      2'd0: x__h3024 = dut_portalIfc_indications_0_notEmpty;
      2'd1: x__h3024 = dut_portalIfc_indications_1_notEmpty;
      2'd2: x__h3024 = dut_portalIfc_indications_2_notEmpty;
      2'd3: x__h3024 = 1'b0 /* unspecified value */ ;
    endcase
  end
  always@(memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT or
	  v__h2741 or x__h3024)
  begin
    case (memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT[21:17])
      5'd0: x1_avValue_data__h2981 = v__h2741;
      5'd4: x1_avValue_data__h2981 = { 31'd0, x__h3024 };
      default: x1_avValue_data__h2981 = 32'd0;
    endcase
  end
  always@(memslave_rs_D_OUT or
