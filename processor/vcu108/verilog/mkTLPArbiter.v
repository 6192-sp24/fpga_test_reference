...
module mkTLPArbiter(CLK,
  ...
  FIFO2 #(.width(32'd153), .guarded(1'd1)) tlp_in_fifo_0(.RST(RST_N),
							 .CLK(CLK),
  ...
  FIFO2 #(.width(32'd153), .guarded(1'd1)) tlp_in_fifo_1(.RST(RST_N),
							 .CLK(CLK),
  ...
  FIFO2 #(.width(32'd153), .guarded(1'd1)) tlp_in_fifo_2(.RST(RST_N),
							 .CLK(CLK),
  ...
  FIFO2 #(.width(32'd153), .guarded(1'd1)) tlp_in_fifo_3(.RST(RST_N),
							 .CLK(CLK),
  ...
  FIFO2 #(.width(32'd153), .guarded(1'd1)) tlp_out_fifo(.RST(RST_N),
							.CLK(CLK),
