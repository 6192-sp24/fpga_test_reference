...
//
// schedule ifc_heard  CF ( portalIfc_slave_read_server_readReq_put,
// 			 portalIfc_slave_read_server_readData_get,
// 			 portalIfc_slave_write_server_writeReq_put,
// 			 portalIfc_slave_write_server_writeData_put,
// 			 portalIfc_slave_write_server_writeDone_get,
...
//
// schedule ifc_heard2  CF ( portalIfc_slave_read_server_readReq_put,
// 			  portalIfc_slave_read_server_readData_get,
// 			  portalIfc_slave_write_server_writeReq_put,
// 			  portalIfc_slave_write_server_writeData_put,
// 			  portalIfc_slave_write_server_writeDone_get,
...
module mkEchoIndicationProxySynth(id,
				  CLK,
				  RST_N,
  ...
  reg [31 : 0] v__h2557, v__h2701, x1_avValue_data__h2887;
  reg CASE_memslave_rsD_OUT_0_dutRDY_portalIfc_ind_ETC__q1,
      CASE_memslave_rsD_OUT_0_dutRDY_portalIfc_ind_ETC__q2,
      x__h2930;
  wire [31 : 0] v___1__h2634, x1_avValue_data__h2903;
  wire [9 : 0] burstCount___1__h1276,
	       burstCount___1__h714,
	       burstCount__h1245,
	       burstCount__h680;
  wire [6 : 0] x__h3174, x__h3427;
  wire [4 : 0] addr__h1243, addr__h678;
  wire IF_memslave_fifoReadAddrGenerator_isFirstReg_T_ETC___d21,
       IF_memslave_fifoWriteAddrGenerator_isFirstReg__ETC___d43,
       NOT_memslave_fifoReadAddrGenerator_addrBeatFif_ETC___d81;
  ...
  // action method ifc_heard
  assign RDY_ifc_heard = dut_RDY_ifc_heard ;

  // action method ifc_heard2
  assign RDY_ifc_heard2 = dut_RDY_ifc_heard2 ;

  // submodule dut
  mkEchoIndicationOutput dut(.CLK(CLK),
			     .RST_N(RST_N),
			     .ifc_heard2_a(dut_ifc_heard2_a),
			     .ifc_heard2_b(dut_ifc_heard2_b),
			     .ifc_heard_v(dut_ifc_heard_v),
			     ...
			     .EN_ifc_heard(dut_EN_ifc_heard),
			     .EN_ifc_heard2(dut_EN_ifc_heard2),
			     ...
			     .RDY_ifc_heard(dut_RDY_ifc_heard),
			     .RDY_ifc_heard2(dut_RDY_ifc_heard2));
  ...
  // register memslave_fifoReadAddrGenerator_addrReg
  assign memslave_fifoReadAddrGenerator_addrReg_D_IN = addr__h678 + 5'd4 ;
  ...
  assign memslave_fifoReadAddrGenerator_isLastReg_D_IN =
	     burstCount__h680 == 10'd2 ;
  assign memslave_fifoReadAddrGenerator_isLastReg_EN =
	     memslave_fifoReadAddrGenerator_requestFifo_EMPTY_N &&
	     memslave_fifoReadAddrGenerator_addrBeatFifo_FULL_N ;

  // register memslave_fifoWriteAddrGenerator_addrReg
  assign memslave_fifoWriteAddrGenerator_addrReg_D_IN = addr__h1243 + 5'd4 ;
  ...
  assign memslave_fifoWriteAddrGenerator_isLastReg_D_IN =
	     burstCount__h1245 == 10'd2 ;
  assign memslave_fifoWriteAddrGenerator_isLastReg_EN =
	     memslave_fifoWriteAddrGenerator_requestFifo_EMPTY_N &&
	     memslave_fifoWriteAddrGenerator_addrBeatFifo_FULL_N ;

  // submodule dut
  assign dut_ifc_heard2_a = ifc_heard2_a ;
  assign dut_ifc_heard2_b = ifc_heard2_b ;
  assign dut_ifc_heard_v = ifc_heard_v ;
  assign dut_portalIfc_messageSize_size_methodNumber = 16'h0 ;
  assign dut_EN_portalIfc_indications_0_deq =
	     WILL_FIRE_RL_memslave_rvrule && memslave_rs_D_OUT == 1'd0 &&
	     !memslave_rsCtrl_D_OUT &&
	     memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT[21:17] ==
	     5'd0 ;
  assign dut_EN_portalIfc_indications_1_deq =
	     WILL_FIRE_RL_memslave_rvrule && memslave_rs_D_OUT == 1'd1 &&
	     !memslave_rsCtrl_D_OUT &&
	     memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT[21:17] ==
	     5'd0 ;
  assign dut_EN_ifc_heard = EN_ifc_heard ;
  assign dut_EN_ifc_heard2 = EN_ifc_heard2 ;
  ...
  // submodule memslave_rs
  assign memslave_rs_D_IN = x__h3174[0] ;
  ...
  // submodule memslave_ws
  assign memslave_ws_D_IN = x__h3427[0] ;
  ...
  assign NOT_memslave_fifoReadAddrGenerator_addrBeatFif_ETC___d81 =
	     (memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT[21:17] !=
	      5'd0 ||
  ...
  assign burstCount___1__h1276 =
	     { 2'd0,
	       memslave_fifoWriteAddrGenerator_requestFifo_D_OUT[15:8] } ;
  assign burstCount___1__h714 =
	     { 2'd0,
	       memslave_fifoReadAddrGenerator_requestFifo_D_OUT[15:8] } ;
  assign burstCount__h1245 =
	     memslave_fifoWriteAddrGenerator_isFirstReg ?
	       burstCount___1__h1276 :
	       memslave_fifoWriteAddrGenerator_burstCountReg ;
  assign burstCount__h680 =
	     memslave_fifoReadAddrGenerator_isFirstReg ?
	       burstCount___1__h714 :
	       memslave_fifoReadAddrGenerator_burstCountReg ;
  assign v___1__h2634 = dut_portalIfc_intr_channel + 32'd1 ;
  assign x1_avValue_data__h2903 =
	     memslave_rsCtrl_D_OUT ? v__h2557 : x1_avValue_data__h2887 ;
  assign x__h3174 = portalIfc_slave_read_server_readReq_put[27:21] - 7'd1 ;
  assign x__h3427 = portalIfc_slave_write_server_writeReq_put[27:21] - 7'd1 ;
  always@(memslave_rs_D_OUT or
	  dut_portalIfc_indications_0_first or
	  dut_portalIfc_indications_1_first)
  begin
    case (memslave_rs_D_OUT)
      1'd0: v__h2701 = dut_portalIfc_indications_0_first;
      1'd1: v__h2701 = dut_portalIfc_indications_1_first;
    endcase
  end
  ...
  begin
    case (memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT[21:17])
      5'd0: v__h2557 = dut_portalIfc_intr_status ? 32'd1 : 32'd0;
      5'd4: v__h2557 = ctrlPort_interruptEnableReg ? 32'd1 : 32'd0;
      5'd8: v__h2557 = 32'd2;
      5'h0C: v__h2557 = dut_portalIfc_intr_status ? v___1__h2634 : 32'd0;
      5'h10: v__h2557 = id;
      5'h14: v__h2557 = ctrlPort_num_portals_reg;
      5'h18: v__h2557 = ctrlPort_cycle_count[63:32];
      5'h1C: v__h2557 = ctrlPort_snapshot;
      default: v__h2557 = 32'h005A05A0;
    endcase
  end
  always@(memslave_rs_D_OUT or
  ...
  begin
    case (memslave_rs_D_OUT)
      1'd0: x__h2930 = dut_portalIfc_indications_0_notEmpty;
      1'd1: x__h2930 = dut_portalIfc_indications_1_notEmpty;
    endcase
  end
  always@(memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT or
	  v__h2701 or x__h2930)
  begin
    case (memslave_fifoReadAddrGenerator_addrBeatFifo_D_OUT[21:17])
      5'd0: x1_avValue_data__h2887 = v__h2701;
      5'd4: x1_avValue_data__h2887 = { 31'd0, x__h2930 };
      default: x1_avValue_data__h2887 = 32'd0;
    endcase
  end
  always@(memslave_rs_D_OUT or
  ...
  // synopsys translate_on
endmodule  // mkEchoIndicationProxySynth
