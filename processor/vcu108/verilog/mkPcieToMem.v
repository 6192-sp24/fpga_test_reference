...
// 				master_write_client_writeData_get,
// 				master_write_client_writeDone_put );
// schedule tlp_response_put  SB ( master_read_client_readReq_get,
// 				master_write_client_writeReq_get );
// schedule tlp_response_put  C ( tlp_response_put );
//
// schedule master_read_client_readReq_get  CF ( tlp_request_get,
// 					      master_read_client_readData_put,
// 					      master_write_client_writeReq_get,
// 					      master_write_client_writeData_get,
// 					      master_write_client_writeDone_put );
...
//
// schedule master_read_client_readData_put  CF ( tlp_request_get,
// 					       tlp_response_put,
// 					       master_read_client_readReq_get,
// 					       master_write_client_writeReq_get,
// 					       master_write_client_writeData_get,
...
//
// schedule master_write_client_writeReq_get  CF ( tlp_request_get,
// 						master_read_client_readReq_get,
// 						master_read_client_readData_put,
// 						master_write_client_writeData_get,
// 						master_write_client_writeDone_put );
...
//
// schedule master_write_client_writeData_get  CF ( tlp_request_get,
// 						 tlp_response_put,
// 						 master_read_client_readReq_get,
// 						 master_read_client_readData_put,
// 						 master_write_client_writeReq_get,
...
//
// schedule master_write_client_writeDone_put  CF ( tlp_request_get,
// 						 tlp_response_put,
// 						 master_read_client_readReq_get,
// 						 master_read_client_readData_put,
// 						 master_write_client_writeReq_get,
...
module mkPcieToMem(my_id,
  ...
  reg [15 : 0] y_avValue_fst_be__h3769;
  ...
  wire [31 : 0] data__h8148,
		...
		x__h1223,
		x__h1366,
		y_avValue_addr__h7347,
		y_avValue_addr__h8045;
  wire [9 : 0] IF_rbc244_ULT_4_THEN_rbc244_ELSE_4__q1,
	       IF_rbc550_ULT_4_THEN_rbc550_ELSE_4__q2,
	       rbc___1__h3567,
	       rbc__h3244,
	       rbc__h3550,
	       y_avValue_burstLen__h7348,
	       y_avValue_burstLen__h8046;
  wire [2 : 0] b__h1163, b__h1490, value__h1322;
  ...
  // action method tlp_response_put
  assign RDY_tlp_response_put = writeHeaderFifo_FULL_N ;
  ...
  assign master_write_client_writeData_get =
	     { data__h8148, writeDataFifo_D_OUT[77:72], 1'd1 } ;
  ...
  SizedFIFO #(.p1width(32'd128),
	      .p2depth(32'd8),
	      .p3cntr_width(32'd3),
	      .guarded(1'd1)) readDataFifo(.RST(RST_N),
					   .CLK(CLK),
  ...
  SizedFIFO #(.p1width(32'd128),
	      .p2depth(32'd8),
	      .p3cntr_width(32'd3),
	      .guarded(1'd1)) readHeaderFifo(.RST(RST_N),
					     .CLK(CLK),
  ...
  SizedFIFO #(.p1width(32'd128),
	      .p2depth(32'd8),
	      .p3cntr_width(32'd3),
	      .guarded(1'd1)) writeDataFifo(.RST(RST_N),
					    .CLK(CLK),
  ...
  SizedFIFO #(.p1width(32'd128),
	      .p2depth(32'd8),
	      .p3cntr_width(32'd3),
	      .guarded(1'd1)) writeHeaderFifo(.RST(RST_N),
					      .CLK(CLK),
  ...
  assign MUX_readBurstCountGreaterThan4_write_1__VAL_1 = rbc__h3244 > 10'd4 ;
  assign MUX_readBurstCountGreaterThan4_write_1__VAL_2 = rbc__h3550 > 10'd4 ;
  ...
  // register address
  assign address_D_IN = 7'h0 ;
  assign address_EN = 1'b0 ;

  // register completionMimoDeqCount
  assign completionMimoDeqCount_D_IN =
	     WILL_FIRE_RL_completionHeader ?
	       IF_rbc244_ULT_4_THEN_rbc244_ELSE_4__q1[2:0] :
	       IF_rbc550_ULT_4_THEN_rbc550_ELSE_4__q2[2:0] ;
  ...
  assign completionMimo_ifc_rDataAvail_D_IN =
	     completionMimo_ifc_rDataAvail + b__h1163 - b__h1490 ;
  assign completionMimo_ifc_rDataAvail_EN = 1'd1 ;

  // register completionMimo_ifc_rDataCount
  assign completionMimo_ifc_rDataCount_D_IN = value__h1322 + b__h1490 ;
  assign completionMimo_ifc_rDataCount_EN = 1'd1 ;

  // register completionMimo_ifc_rStorage
  assign completionMimo_ifc_rStorage_D_IN = nextStorage__h1044 ;
  assign completionMimo_ifc_rStorage_EN = 1'd1 ;

  // register completionMimo_ifc_rStorageMask
  assign completionMimo_ifc_rStorageMask_D_IN = nextMask__h1045 ;
  ...
  assign readBurstCount_D_IN =
	     WILL_FIRE_RL_continuation ? rbc__h3550 : rbc__h3244 ;
  ...
  assign readHeaderFifo_ENQ =
	     EN_tlp_response_put && tlp_response_put[152] &&
	     tlp_response_put[126:125] == 2'd0 &&
	     readHeaderFifo_FULL_N ;
  ...
  assign writeHeaderFifo_ENQ =
	     ...
	     tlp_response_put[152] &&
	     writeHeaderFifo_FULL_N ;
  assign writeHeaderFifo_DEQ = EN_master_write_client_writeReq_get ;
  assign writeHeaderFifo_CLR = 1'b0 ;

  // remaining internal signals
  assign IF_rbc244_ULT_4_THEN_rbc244_ELSE_4__q1 =
	     (rbc__h3244 < 10'd4) ? rbc__h3244 : 10'd4 ;
  assign IF_rbc550_ULT_4_THEN_rbc550_ELSE_4__q2 =
	     (rbc__h3550 < 10'd4) ? rbc__h3550 : 10'd4 ;
  assign _0_CONCAT_IF_readBurstCountGreaterThan4_5_THEN__ETC___d132 =
	     { 7'd0,
	       readBurstCountGreaterThan4 ?
		 16'hFFFF :
		 y_avValue_fst_be__h3769,
	       spliced_bits__h3834,
	       spliced_bits__h3864,
	       spliced_bits__h3894,
	       spliced_bits__h3924 } ;
  assign b__h1163 =
	     completionMimo_ifc_rwDeqCount_whas ?
	       ...
	       3'd0 ;
  assign b__h1490 = EN_master_read_client_readData_put ? 3'd1 : 3'd0 ;
  assign data__h8148 =
	     { writeDataFifo_D_OUT[7:0],
	       writeDataFifo_D_OUT[15:8],
	       writeDataFifo_D_OUT[23:16],
	       writeDataFifo_D_OUT[31:24] } ;
  assign enqData__h1042 = x__h1259 << x__h1366 ;
  assign enqMask__h1043 = x__h1374 << x__h1366 ;
  assign nextMask__h1037 = completionMimo_ifc_rStorageMask >> x__h1223 ;
  assign nextMask__h1045 = nextMask__h1037 | enqMask__h1043 ;
  assign nextStorage__h1036 = completionMimo_ifc_rStorage >> x__h1223 ;
  assign nextStorage__h1044 = x__h1102 | y__h1103 ;
  assign rbc___1__h3567 = readBurstCount - 10'd4 ;
  assign rbc__h3244 = readDataFifo_D_OUT[105:96] - 10'd1 ;
  assign rbc__h3550 = readBurstCountGreaterThan4 ? rbc___1__h3567 : 10'd0 ;
  assign spliced_bits__h3834 =
  ...
  assign value__h1260 =
	     EN_master_read_client_readData_put ?
	       ...
	       32'd0 ;
  assign value__h1322 = completionMimo_ifc_rDataCount - b__h1163 ;
  assign value__h1375 =
	     EN_master_read_client_readData_put ? 32'hFFFFFFFF : 32'd0 ;
  assign x__h1102 = nextStorage__h1036 & nextMask__h1037 ;
  assign x__h1223 = { 24'd0, b__h1163, 5'd0 } ;
  assign x__h1259 = { 96'd0, value__h1260 } ;
  assign x__h1366 = { 24'd0, value__h1322, 5'd0 } ;
  assign x__h1374 = { 96'd0, value__h1375 } ;
  assign y__h1103 = enqData__h1042 & enqMask__h1043 ;
  assign y_avValue_addr__h7347 = { readHeaderFifo_D_OUT[63:34], 2'd0 } ;
  assign y_avValue_addr__h8045 = { writeHeaderFifo_D_OUT[63:34], 2'd0 } ;
  assign y_avValue_burstLen__h7348 = { readHeaderFifo_D_OUT[103:96], 2'd0 } ;
  assign y_avValue_burstLen__h8046 = { writeHeaderFifo_D_OUT[103:96], 2'd0 } ;
  always@(readBurstCount)
  begin
    case (readBurstCount)
      10'd0: y_avValue_fst_be__h3769 = 16'd0;
      10'd1: y_avValue_fst_be__h3769 = 16'hF000;
      10'd2: y_avValue_fst_be__h3769 = 16'hFF00;
      10'd3: y_avValue_fst_be__h3769 = 16'hFFF0;
      default: y_avValue_fst_be__h3769 = 16'hFFFF;
    endcase
  end
  ...
  begin
    if (RST_N == `BSV_RESET_VALUE)
      begin
        address <= `BSV_ASSIGNMENT_DELAY 7'd0;
	...
	tlpTag <= `BSV_ASSIGNMENT_DELAY 8'd0;
      ...
      begin
        if (address_EN) address <= `BSV_ASSIGNMENT_DELAY address_D_IN;
