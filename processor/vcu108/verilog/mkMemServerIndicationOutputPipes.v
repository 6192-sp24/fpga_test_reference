...
module mkMemServerIndicationOutputPipes(CLK,
  ...
  wire [31 : 0] IF_reportStateDbg_responseAdapter_notEmptyReg__ETC___d56;
  wire [2 : 0] x__h1603;
  wire [1 : 0] x__h1351;
  wire x__h1224, x__h1477;
  ...
  assign portalIfc_intr_channel =
	     addrResponse_responseAdapter_notEmptyReg ?
	       32'd0 :
	       IF_reportStateDbg_responseAdapter_notEmptyReg__ETC___d56 ;
  ...
  assign addrResponse_responseAdapter_count_D_IN =
	     !addrResponse_responseAdapter_count && x__h1224 ;
  ...
  assign error_responseAdapter_count_D_IN =
	     (error_responseAdapter_count == 3'd5) ? 3'd0 : x__h1603 ;
  ...
  assign reportMemoryTraffic_responseAdapter_count_D_IN =
	     !reportMemoryTraffic_responseAdapter_count && x__h1477 ;
  ...
  // remaining internal signals
  assign IF_reportStateDbg_responseAdapter_notEmptyReg__ETC___d56 =
	     reportStateDbg_responseAdapter_notEmptyReg ?
	       32'd1 :
	       (reportMemoryTraffic_responseAdapter_notEmptyReg ?
		  32'd2 :
		  (error_responseAdapter_notEmptyReg ?
		     32'd3 :
		     32'hFFFFFFFF)) ;
  assign x__h1224 = addrResponse_responseAdapter_count + 1'd1 ;
  assign x__h1351 = reportStateDbg_responseAdapter_count + 2'd1 ;
  assign x__h1477 = reportMemoryTraffic_responseAdapter_count + 1'd1 ;
  assign x__h1603 = error_responseAdapter_count + 3'd1 ;
