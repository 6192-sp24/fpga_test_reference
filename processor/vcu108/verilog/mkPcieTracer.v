...
module mkPcieTracer(CLK,
  ...
  wire [31 : 0] fromttd_timestamp__h8327, tottd_timestamp__h8496;
  wire [10 : 0] v__h8219;
  wire [6 : 0] fromttd_source__h8328, tottd_source__h8497;
  ...
  assign MUX_fromPcieTraceBram_cbram_bram_a_put_3__VAL_2 =
	     { fromttd_timestamp__h8327,
	       fromttd_source__h8328,
  ...
  assign MUX_tlpTraceBramWrAddrReg_write_1__VAL_2 = v__h8219 + 11'd1 ;
  ...
  always@(MUX_tlpTraceBramWrAddrReg_write_1__SEL_1 or
	  ...
	  WILL_FIRE_RL_doTracing or v__h8219)
  begin
    case (1'b1) // synopsys parallel_case
	  ...
	  toPcieTraceBram_cbram_bram_ADDRA =
	      traceServer_bramServer_request_put[202:192];
      WILL_FIRE_RL_doTracing: toPcieTraceBram_cbram_bram_ADDRA = v__h8219;
  ...
  assign fromttd_source__h8328 = fromPcie_whas ? 7'h04 : 7'd0 ;
  assign fromttd_timestamp__h8327 = fromPcie_whas ? timestamp : 32'd0 ;
  ...
  assign tottd_source__h8497 = toPcie_whas ? 7'h08 : 7'd0 ;
  assign tottd_timestamp__h8496 = toPcie_whas ? timestamp : 32'd0 ;
  assign v__h8219 =
	     tlpTraceBramWrAddrFifo_EMPTY_N ?
