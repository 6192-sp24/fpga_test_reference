...
module mkMMURequestOutputPipes(CLK,
  ...
  wire [31 : 0] IF_idRequest_responseAdapter_notEmptyReg_THEN__ETC___d52;
  wire [3 : 0] x__h1591;
  wire [2 : 0] x__h1464;
  wire x__h1845;
  ...
  assign portalIfc_intr_channel =
	     sglist_responseAdapter_notEmptyReg ?
	       ...
	       (region_responseAdapter_notEmptyReg ?
		  32'd1 :
		  IF_idRequest_responseAdapter_notEmptyReg_THEN__ETC___d52) ;
  ...
  assign region_responseAdapter_count_D_IN =
	     (region_responseAdapter_count == 4'd12) ? 4'd0 : x__h1591 ;
  ...
  assign setInterface_responseAdapter_count_D_IN =
	     !setInterface_responseAdapter_count && x__h1845 ;
  ...
  assign sglist_responseAdapter_count_D_IN =
	     (sglist_responseAdapter_count == 3'd4) ? 3'd0 : x__h1464 ;
  ...
  // remaining internal signals
  assign IF_idRequest_responseAdapter_notEmptyReg_THEN__ETC___d52 =
	     idRequest_responseAdapter_notEmptyReg ?
	       32'd2 :
	       (idReturn_responseAdapter_notEmptyReg ?
		  32'd3 :
		  (setInterface_responseAdapter_notEmptyReg ?
		     32'd4 :
		     32'hFFFFFFFF)) ;
  assign x__h1464 = sglist_responseAdapter_count + 3'd1 ;
  assign x__h1591 = region_responseAdapter_count + 4'd1 ;
  assign x__h1845 = setInterface_responseAdapter_count + 1'd1 ;
