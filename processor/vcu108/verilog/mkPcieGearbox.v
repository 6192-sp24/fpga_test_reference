...
module mkPcieGearbox(CLK_epClock250,
  ...
  wire [7 : 0] be__h11720, be__h11829;
  wire [1 : 0] x__h12176,
	       x__h12523,
	       x__h13803,
	       x__h14156,
  ...
  assign RDY_pci_request_put =
	     (!fifoTxData_write_block && x__h12176 == 2'd3 ||
	      fifoTxData_write_block && x__h12523 == 2'd3) &&
  ...
  assign RDY_pci_response_get =
	     (!fifoRxData_read_block && x__h13803 == 2'd3 ||
	      fifoRxData_read_block && x__h14156 == 2'd3) &&
  ...
  // submodule inFifo
  FIFO2 #(.width(32'd81), .guarded(1'd1)) inFifo(.RST(RST_N_epReset250),
						 .CLK(CLK_epClock250),
						 .D_IN(inFifo_D_IN),
						 .ENQ(inFifo_ENQ),
						 .DEQ(inFifo_DEQ),
  ...
  // submodule outFifo
  FIFO2 #(.width(32'd81), .guarded(1'd1)) outFifo(.RST(RST_N_epReset250),
						  .CLK(CLK_epClock250),
						  .D_IN(outFifo_D_IN),
						  .ENQ(outFifo_ENQ),
						  .DEQ(outFifo_DEQ),
  ...
  assign outFifo_ENQ =
	     WILL_FIRE_RL_process_outgoing_packets &&
	     (fifoTxData_read_block ? be__h11829 : be__h11720) != 8'd0 ;
  ...
  assign NOT_fifoRxData_write_block_AND_NOT_NOT_fifoRxD_ETC___d32 =
	     (!fifoRxData_write_block && x__h3909 != 2'd3 ||
	      fifoRxData_write_block && x__h4340 != 2'd3) &&
	     !fifoRxData_sInReset_pre_isInReset ;
  assign NOT_fifoTxData_read_block_7_8_AND_NOT_fifoTxDa_ETC___d120 =
	     (!fifoTxData_read_block && x__h9457 != 2'd3 ||
	      fifoTxData_read_block && x__h9879 != 2'd3) &&
	     !fifoTxData_dInReset_pre_isInReset ;
